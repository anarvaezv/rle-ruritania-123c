...
- Access to the GCP project (e.g., `rle-ruritania-123c`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-123c" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-123c.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-123c --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-123c.iam.gserviceaccount.com" \
  --project="rle-ruritania-123c" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-123c.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-123c.
